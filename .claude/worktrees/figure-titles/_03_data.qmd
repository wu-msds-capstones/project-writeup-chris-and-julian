...
SRC_FILL = "#DCEEF7"; SRC_BORDER = "#2A78D6"
...
digraph architecture {{
  ...
  bgcolor="#FCFCFB"
  fontname="Helvetica"
  label="Data Architecture, Source to Output"
  labelloc="t"
  fontsize=14
  ...
  subgraph cluster_source {{
    ...
    bgcolor="#F9F9F7"
    margin=18
    node [style="filled,rounded", fillcolor="{SRC_FILL}", color="{SRC_BORDER}", margin="0.1,0.05", fontsize=10]
  ...
  subgraph cluster_lake {{
    ...
    bgcolor="#F9F9F7"
    margin=18
    node [style="filled,rounded", fillcolor="{LAKE_FILL}", color="{LAKE_BORDER}", margin="0.1,0.05", fontsize=10]
  ...
  subgraph cluster_output {{
    ...
    bgcolor="#F9F9F7"
    margin=18
    node [style="filled,rounded", fillcolor="{OUT_FILL}", color="{OUT_BORDER}", margin="0.1,0.05", fontsize=10]
  ...
  county_affordability -> analysis_table [label="  joined with the other fact tables  ", fontsize=8, fontcolor="#8F8D87", ltail="cluster_warehouse"]
...
ggplot(funnel_df, aes(x=x, y=0)) +
  ...
  labs(title="From Source Frame to Estimation Sample") +
  theme_void() +
