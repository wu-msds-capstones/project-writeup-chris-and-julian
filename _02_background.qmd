...
p_pov <- ggplot(context_sf) +
  ...
  scale_fill_gradient(low="#FCFCFB", high="#EB6834", limits=c(pov_ctx_vmin, pov_ctx_vmax),
...
p_unemp <- ggplot(context_sf) +
  ...
  scale_fill_gradient(low="#FCFCFB", high="#C2255C", limits=c(unemp_ctx_vmin, unemp_ctx_vmax),
...
p_inc <- ggplot(context_sf) +
  ...
  scale_fill_gradient(low="#FCFCFB", high="#1BAF7A", limits=c(inc_ctx_vmin, inc_ctx_vmax),
...
p_rpp <- ggplot(context_sf) +
  ...
  scale_fill_gradient(low="#FCFCFB", high="#2A78D6", limits=c(rpp_ctx_vmin, rpp_ctx_vmax),
                      oob=scales::squish, na.value="#EEEEEE",
