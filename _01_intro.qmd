...
We estimate a panel regression with year indicators and standard errors clustered by county, which accounts for the dependence among repeated observations of the same county. Diagnostics on that specification motivated a log respecification, after which random forest and neural network models tested whether additional flexibility captured structure the linear specification missed. @sec-analysis describes the modeling strategy and diagnostics.
