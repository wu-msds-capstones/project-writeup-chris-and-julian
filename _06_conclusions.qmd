...
Second, much of the task based literature has relied on broader labor market units such as commuting zones. This study instead uses the county as the unit of analysis. That finer scale connects task groups more directly to the economic conditions experienced by local residents. The county year panel also allows those differences to be followed from 2008 through 2023 rather than treated as a single cross sectional comparison.
