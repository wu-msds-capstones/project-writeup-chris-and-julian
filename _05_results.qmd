...
style_table(GT(level_coef_df)
  .fmt_number(columns=["Coefficient ($)","Std. Error"], decimals=0, use_seps=True)
...
ggplot(area_df, aes(x=year, y=share, fill=group)) +
  ...
  annotate("text", x=2009.65, y=1.06, label="Census coding change", hjust=0, vjust=0.5, size=3.1, fontface="bold", color="#0B0B0B") +
  annotate("text", x=2020.15, y=1.06, label="No data", hjust=0, vjust=0.5, size=3.1, fontface="bold", color="grey45") +
