...
#| echo: false
#| tbl-cap: "Level panel regression coefficients for the task groups and controls, with standard errors, t-statistics, and p-values. Non-routine cognitive is the reference task group."

style_table(GT(level_coef_df)
  .tab_header(title="Panel Regression Coefficients, Level Specification")
...
#| echo: false
#| tbl-cap: "Held out performance on the same held out counties from the single grouped split."
...
#| echo: false
#| warning: false
#| fig-cap: "**Actual vs. Random Forest Purchasing Power by Routine Cognitive Share.** Mean actual and predicted purchasing power across ten equal count bins of routine cognitive work, on the held out test counties, with predictions from the log target forest back transformed into dollars; each point marks a bin's mean routine cognitive share. The relationship rises then declines rather than moving monotonically; the forest reproduces this same shape rather than finding a different one."
...
#| echo: false
#| warning: false
#| fig-cap: "**Loss in Held Out R² When Each Feature Block Is Removed.** From the log target random forest, relative to the full model's 0.876. Removing poverty and unemployment costs more than four times as much as removing the task groups."
...
#| label: tbl-rankcorr
#| echo: false
#| tbl-cap: "Spearman rank correlation of county orderings between 2010 and 2023, by task group, across counties present in both years."
