...
The reference group logic of @fig-vif applies here unchanged. What is new in this feature set is the indicator blocks, and @tbl-vif-ml shows they introduce no collinearity of their own.
...
#| label: tbl-vif-ml
#| echo: false
#| tbl-cap: "**Variance Inflation Factors for the Indicator Blocks.** The ten highest values across the year and state indicator blocks, after removing the reference task group. All ten are year indicators, and all fall below the conventional threshold of 5."
