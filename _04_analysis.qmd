...
# the strip carries the group name alone, centered; the letter tag is drawn
# separately at the top right of each panel so the two do not share one string
...
ggplot(uni_pts, aes(x=share, y=affordability_salary)) +
  ...
  geom_text(data=tag_df, aes(x=Inf, y=Inf, label=tag), inherit.aes=FALSE,
            hjust=1.4, vjust=1.5, fontface="bold", size=4.2, color="#0B0B0B") +
