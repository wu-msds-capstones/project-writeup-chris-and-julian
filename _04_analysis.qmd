...
# Two solid fills rather than one color at two opacities: each in-bar label then
# clears the 4.5:1 contrast floor (grey with ink 5.9, purple with white 13.6).
...
ggplot(bw_df, aes(x=value, y=group, fill=component)) +
  ...
  scale_fill_manual(values=c("Between Counties"=GREY,
