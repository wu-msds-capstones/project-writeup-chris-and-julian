...
Keeping Regional Price Parities on their own relational path, rather than copying each metropolitan parity onto every county in that area, preserves the geographic level BEA reports at and avoids duplicating the same value across county records.
