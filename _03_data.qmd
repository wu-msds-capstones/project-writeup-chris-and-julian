...
- confirm which script writes county_employment_composition (suspected: ACS category
  counts, not PUMS)
- resolve O*NET and OEWS: neither appears in tbl-sources, but O*NET maps to
  county_task_exposure in the warehouse. Either they contribute nothing and the poster
  source table needs correcting to match this section, or they contribute something this
  section is silent about
- sweep non-routine hyphenation across all seven section files for consistency
-->
