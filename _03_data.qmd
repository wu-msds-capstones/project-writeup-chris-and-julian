...
def entity(name, rows):
    body = f'<TR><TD COLSPAN="3" BGCOLOR="#3B9AB2"><FONT COLOR="white" POINT-SIZE="15"><B>{name}</B></FONT></TD></TR>'
    for typ, col, marker in rows:
        m = f'<FONT COLOR="#8D8680" POINT-SIZE="10">{marker}</FONT>' if marker else ""
...
# Fill/border pairs recomputed 13 Aug 2026 to match the Zissou1-derived general palette in
# capstone.qmd (BLUE/ORANGE/GREEN/PINK/GREY) — fills are ~17% tints of each border color.
CENSUS_FILL = "#DEEEF2"; CENSUS_BORDER = "#3B9AB2"
BEA_FILL = "#FCF6DB"; BEA_BORDER = "#EBCC2A"
BLS_FILL = "#FAF1D4"; BLS_BORDER = "#E1AF00"
OUT_FILL = "#E8F3F5"; OUT_BORDER = "#78B7C5"
LAKE_FILL = "#ECEAE9"; LAKE_BORDER = "#8D8680"
